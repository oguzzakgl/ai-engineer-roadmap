...
with engine.connect() as conn:
    # SQL ile tablo silme ve sıfırdan oluşturma (İlişkilerden dolayı önce promptlar silinmeli)
...
# Testleri çalıştıralım (Yukarıdaki ödevleri tamamladığında sonuçları göreceksin)
